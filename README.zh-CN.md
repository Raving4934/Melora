...
5. **发布通道与升级说明**：
   - Android 与 Web/NAS 使用独立版本标签；当前 Android 基准为 `android-v0.1.4`，Web/NAS 基准为 `v0.1.1`；
   - Android 正式签名保持不变，`versionCode` 已升至 `11`。可直接覆盖安装新版 APK，无需卸载或清空数据。
...
1. **下载安装**：前往 [GitHub Releases](https://github.com/Raving4934/Melora/releases) 下载 `melora-android-v0.1.4-arm64-v8a.apk` 并安装。
